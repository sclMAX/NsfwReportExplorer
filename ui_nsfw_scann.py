...
class Ui_dlgNsfwScanner(object):
    def setupUi(self, dlgNsfwScanner):
        ...
        self.lblTime.setMaximumSize(QtCore.QSize(16, 16))
        palette = QtGui.QPalette()
        ...
        self.lblTime.setPalette(palette)
        self.lblTime.setText("")
        self.lblTime.setPixmap(QtGui.QPixmap("LibIcons/icon-hourglassalt.png"))
        self.lblTime.setScaledContents(True)
        self.lblTime.setObjectName("lblTime")
        self.horizontalLayout_4.addWidget(self.lblTime, 0, QtCore.Qt.AlignLeft)
        ...
        self.horizontalLayout_4.addWidget(self.lblProgressBar)
